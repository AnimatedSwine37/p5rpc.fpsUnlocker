...
internal class Utils
{
    ...
    internal static void LogDebug(string message)
    {
        if (_config.DebugEnabled)
            _logger.WriteLine($"[FPS Unlocker] {message}");
    }
    ...
    {
        _logger.WriteLine($"[FPS Unlocker] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[FPS Unlocker] {message}", System.Drawing.Color.Red);
    }
